<?php require_once("ajax/db.php"); ?>
    ...
    <div class="singleTraining col-xs-12">
        ...
        <h3><? echo langs("LISTA MOICH SZKOLEŃ:"); ?> ({{trainings.length}})</h3>
    </div>
    ...
    <div class="szkolenia" style="padding:20px;"> 
        <table class="table table-striped table-responsive table-hover">
            <tr>
                ...
                <th style="width:35px;"><? echo langs("edytuj"); ?></th>
            </tr>
            <tr ng-repeat="training in trainings | filter : search">
                ...
                <td class="cn-left">
                    <button mwl-confirm
                        title="Na pewno edytować?"
                        message="Wskazówka: Potwierdź aby otworzyć szkolenie do edycji..."
                        confirm-text="Edit"
                        cancel-text="Cancel"
                        on-confirm="editTraining(training)"
                        on-cancel=""
                        confirm-button-type="warning"
                        cancel-button-type="info"
                        class="btn btn-xs btn-warning"><i class="fa fa-pencil-square-o"></i>
                    </button>
                </td>
