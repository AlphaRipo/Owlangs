<?php require_once("ajax/db.php"); ?>
    ...
    <div class="singleTraining col-xs-12">
        ...
        <h3 ng-bind="( '<? echo langs("LISTA WSZYSTKICH SZKOLEŃ:"); ?>'+' ('+trainings.length+')' )"></h3>
    </div>
    ...
    <div class="szkolenia" style="padding:20px;"> 
        <table class="table table-striped table-responsive table-hover">
            ...
            <tr ng-repeat="training in trainings | filter : search">
                ...
                <td class="cn-left"><a ng-href="/#/training/{{training.id}}"><span ng-bind="training.name"></span> <i class="fa fa-angle-double-right"></i></a></td>
