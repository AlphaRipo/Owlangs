...
<div id="sownik" class="row">
    ...
    <div ng-if="cannot === 1" class="col-xs-12">
        <div style="text-align:left;" class="alert alert-danger"><i class="fa fa-lg fa-frown-o" aria-hidden="true"></i> <? echo langs("Ups! Kategoria nie dodana, ponieważ <strong>pakiet FREE może posidać tylko 1 kategorię</strong> ograniczoną do 100 słówek"); ?></div>
    </div>
    ...
    <div class="col-xs-5">
        <div class="input-group">
            <input id="searchDict" ng-model="searchId" type="text" class='form-control' placeholder="<? echo langs("Wyszukaj w sowniku po ID..."); ?>">
            <span class="input-group-btn">
                <button class="btn btn-default" id='searchBtn' type="button" data-toggle="tooltip" data-placement="top" title="<? echo langs("Kliknij by wyczyścić pole."); ?>" ng-click="clearFilterPart1();"><i class="fa fa-times"></i></button>
    ...
    <div class="col-xs-7">
        <div class="input-group">
            <input id="searchDict" ng-model="searchText" type="text" class='form-control' placeholder="<? echo langs("Wyszukaj w sowniku po innych parametrach..."); ?>">
            <span class="input-group-btn">
                <button class="btn btn-default" id='searchBtn' type="button" data-toggle="tooltip" data-placement="top" title="<? echo langs("Kliknij by wyczyścić pole."); ?>" ng-click="clearFilterPart2();"><i class="fa fa-times"></i></button>
                <button class="btn btn-default" id='searchBtn' type="button" data-toggle="tooltip" data-placement="top" title="<? echo langs("Kliknij by wyszukać."); ?>"><i class="fa fa-search"></i></button>
            </span>
        </div>
    </div>
    ...
    <div class="col-xs-12 nopadding"> 
        ...
        <table class="table table-striped table-responsive table-hover">
            <tr>
                ...
                <th>Words</th>
                <!--<th width="90px;"></th>-->
                <th width="90"><button ng-click="addCategoryPanelReverse()" data-toggle="tooltip" data-placement="top" title="<? echo langs("Kliknij aby dodać kategorię!"); ?>" class="btn btn-xs cn-tips btn-block btn-success"><i class="fa fa-plus"></i> add</button></th>
            </tr>

            <tr ng-repeat=" dict in dicts | filter : getFilterPart1(searchId) : getFilterPart2(searchId) | filter : searchText ">
                ...
                <td>
                    <a ng-href="/#/user/{{dict.author}}"><img class="img-thumbnail" data-toggle="tooltip" data-placement="top" data-original-title="{{dict.imie}} {{dict.nazwisko}}" ng-src="{{dict.avatar}}" width="40"></a>
                </td>
                <td width="95">
                ...
                <td>
                    ...
                    <button ng-show="dict.author === aboutMe.me" 
                        mwl-confirm 
                        title="<? echo langs("Na pewno usunąć?"); ?>"
                        message="<? echo langs("Wskazówka: Ta kategoria zniknie na zawsze bez możliwości przywrócenia!"); ?>"
                        confirm-text="Delete" 
                        cancel-text="Cancel" 
                        on-confirm="delDict(dict)" 
                        on-cancel="" 
                    ...
                    <button ng-show="dict.author !== aboutMe.me" data-toggle="tooltip" data-placement="top" title="<? echo langs("Ważne! Możesz usuwać kategorie tylko gdy jesteś ich właścicielem."); ?>" class="btn btn-xs btn-default">
                        <i class="fa fa-lock"></i>
                    </button>
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel"><? echo langs("Słówka w kategorii numer").":"; ?> <span ng-bind="selectedDict.id"></span></h4>
            </div>
            <div class="modal-body">
                    ...
                    <table class="table table-striped table-responsive table-hover">
                        ...
                        <tr ng-repeat="word in selectedDict.words | filter : search">
                            ...
                            <td>
                                ...
                                <button ng-show="word.author === aboutMe.me" ng-click="editWord = !editWord; saveWord(editWord,word,$index);" class="btn btn-xs btn-warning" data-toggle="tooltip" data-placement="top" title="<? echo langs("Kliknij aby edytować pozycję!"); ?>">
                                    <i class="fa fa-pencil"></i>
                                </button>
                                
                                <button ng-show="word.author !== aboutMe.me" data-toggle="tooltip" data-placement="top" title="<? echo langs("Ważne! Możesz edytować słowo tylko gdy jesteś jego właścicielem."); ?>" class="btn btn-xs btn-default">
                                    <i class="fa fa-lock"></i>
                                </button>
                                
                                <button ng-show="word.author === aboutMe.me" 
                                    mwl-confirm 
                                    title="<? echo langs("Na pewno usunąć?"); ?>"
                                    message="<? echo langs("Wskazówka: Te słówko zniknie na zawsze bez możliwości przywrócenia!"); ?>"
                                    confirm-text="Delete" 
                                    cancel-text="Cancel" 
                                ...
                                <button ng-show="word.author !== aboutMe.me" data-toggle="tooltip" data-placement="top" title="<? echo langs("Ważne! Możesz usuwać słowo tylko gdy jesteś jego właścicielem."); ?>" class="btn btn-xs btn-default">
                                    <i class="fa fa-lock"></i>
                                </button>
                ...
                <div class="col-xs-12"> 
                    <div ng-show="addWordsPanel && selectedDict.author === aboutMe.me" class="panel panel-success">
            ...
            <div class="modal-footer">
                ...
                <button ng-if="selectedDict.exist === 0" type="button" ng-click="saveInMyDict(selectedDict);" class="pull-left btn cn-tips btn-primary"><i class="fa fa-files-o" aria-hidden="true"></i> Copy whole category to my dict</button>
                <button ng-if="selectedDict.exist > 0" type="button" class="pull-left btn cn-tips btn-success"><i class="fa fa-files-o" aria-hidden="true"></i> This category has been copied</button>
                <button ng-disabled="selectedDict.author !== aboutMe.me" type="button" ng-click="addWordsPanel =! addWordsPanel" class="btn cn-tips btn-success"><i class="fa fa-plus"></i> add more words</button>
                    ...
                    <table class="table table-striped table-responsive table-hover">
                        ...
                        <tr ng-repeat="word in newDictWords | filter : search">
                            ...
                            <td>
                                ...
                                <button ng-show="word.author === myId" ng-click="editWord = !editWord" class="btn btn-xs btn-warning" data-toggle="tooltip" data-placement="top" title="<? echo langs("Kliknij aby edytować pozycję!"); ?>">
                                    <i class="fa fa-pencil"></i>
                                </button>
                                
                                <button ng-show="word.author !== myId" class="btn btn-xs btn-default" data-toggle="tooltip" data-placement="top" title="<? echo langs("Nie możesz edytować tej pozycji, nie jesteś jej autorem!"); ?>">
                                    <i class="fa fa-lock"></i>
                                </button>
                                
                                <button ng-show="word.author === myId && wordsToMyDict.length === 0" ng-click="delWord(word,$index)" class="btn btn-xs btn-danger" data-toggle="tooltip" data-placement="top" title="<? echo langs("Kliknij aby usunąć tą pozycję!"); ?>">
                                    <i class="fa fa-times"></i>
                                </button>
                                
                                <button ng-show="wordsToMyDict.length !== 0" ng-click="delMyDictWord(word)" class="btn btn-xs btn-danger" data-toggle="tooltip" data-placement="top" title="<? echo langs("Kliknij aby usunąć tą pozycję z tej listy!"); ?>">
                                    <i class="fa fa-times"></i>
                                </button>
                                
                                <button ng-show="word.author !== myId && wordsToMyDict.length === 0" class="btn btn-xs btn-default" data-toggle="tooltip" data-placement="top" title="<? echo langs("Nie możesz usunąć tej pozycji, nie jesteś jej autorem!"); ?>">
                                    <i class="fa fa-lock"></i>
                                </button>
