...
<div class="tab-content">
    <div id="sownik" class="row">
        ...
        <div class="col-md-4 col-xs-12 nopadding"></div>
        <div class="col-md-4 col-xs-12 nopadding"><a class="btn btn-warning center-block" ng-click="getRandomWords();"><i class="fa fa-random" aria-hidden="true"></i> <? echo langs("Losuj nowe wyzwanie"); ?></a></div>
        <div class="col-md-4 col-xs-12 nopadding"></div>
